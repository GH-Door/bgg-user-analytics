...
이 문서는 `/Users/mungughyeon/Documents/Bootcamp/zero-base/Final Project/`의 2024년 7월 수집 데이터(CSV + 수집/EDA 노트북)와, 이번 프로젝트에서 새로 설계한 수집 스키마(`src/collectors/*.py`)의 피처를 테이블 단위로 대조한다. 목적은 두 가지다.
