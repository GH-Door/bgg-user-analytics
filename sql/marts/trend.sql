...
--
-- 09/08 확인: 현재 미사용. jupyter/04.Trend.ipynb가 H1(반복 플레이)·H2(세그먼트
-- 시간축)·H3(코호트 참여율) 체계로 재설계되면서 협력 게임 비중 가설은 최종
-- 범위에서 빠졌다. 마트 자체는 유효하게 실행되므로 지우지 않고 남겨둔다 —
-- 나중에 협력 게임 트렌드 분석을 다시 다루게 되면 그대로 재사용 가능.
--
